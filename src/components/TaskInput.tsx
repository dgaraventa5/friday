...
export function TaskInput({ categories, onAddTask, onCancel, isExpanded = false }: TaskInputProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newTask: Task = {
      ...
      recurringEndCount: task.isRecurring && task.recurringEndType === 'after' ? task.recurringEndCount : undefined,
    ...
    <div className="bg-[#f7f7f7] rounded-lg border border-neutral-50 shadow-card p-6 animate-slide-up font-sans">
      <form onSubmit={handleSubmit} className="space-y-6 w-full">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold text-neutral-900 font-sans">Add New Task</h3>
          <Button
            type="button"
